...
import { Lead, Product, Order, Quotation, Invoice } from "../types";
...
interface CRMContextType {
  ...
  addQuotation: (data: Partial<Quotation> | FormData) => Promise<void>;
  updateQuotation: (id: string, data: Partial<Quotation>) => Promise<void>;
  deleteQuotation: (id: string) => Promise<void>;
  addInvoice: (data: Partial<Invoice> | FormData) => Promise<void>;
...
export const CRMProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const fetchData = async () => {
    try {
      const [l, p, o, q, i] = await Promise.all([
        API.get("/leads"),
        API.get("/products"),
        API.get("/orders"),
        API.get("/quotations"),
  ...
  return (
    <CRMContext.Provider value={{
      leads, products, orders, quotations, invoices,
