...
export const Products: React.FC = () => {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    setFormData((prev) => ({
      ...prev,
      [name]: name === 'price' ? (value === '' ? '' : parseFloat(value)) : name === 'stock' ? (value === '' ? 0 : parseInt(value)) : value,
    }));
  };
            ...
            <tbody>
              {products.map((product) => (
                <tr key={product.id}>
                  ...
                  <td className={product.stock < 10 ? 'text-red-500 font-bold' : 'text-green-600 font-bold'}>
                    {product.stock}
                  </td>
