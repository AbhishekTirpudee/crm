...
export const generateQuotationPDF = async (data) => {
  return new Promise((resolve, reject) => {
    try {
      const {
        items, lead, quotationNumber, currency, taxRate,
      ...
      doc.font("Helvetica").text("Billing: " + clientAddress, 320, startY + 35, { width: 220 });
      if (clientShipping) {
        doc.text("Shipping: " + clientShipping, 320, startY + 65, { width: 220 });
      }
      doc.text(`Contact: ${clientPhone}`, 320, startY + 95);
