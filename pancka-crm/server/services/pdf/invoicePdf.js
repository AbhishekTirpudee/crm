...
export const generateInvoicePDF = async (data) => {
  return new Promise((resolve, reject) => {
    try {
      const {
        items, customer, invoiceNumber, currency, taxRate,
      ...
      doc.font("Helvetica").text(customer.address || "N/A", 320, startY + 35, { width: 220 });
      doc.text(`Contact: ${customer.phone || "N/A"}`, 320, startY + 65);
      doc.text(`Email: ${customer.email || "N/A"}`, 320, startY + 80);
